  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="space-y-8">
        ...
        {!user.is_verified && <EmailVerification onVerified={refreshUser} />}
...
function ProfileInfo({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await apiUpdateProfile({ name, username: username.toLowerCase() });
      await onUpdate();
    ...
    <section className="rounded-xl border border-[#333] bg-[#242424] p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center rounded-lg border border-[#333] bg-[#1a1a1a] focus-within:border-accent">
            <span className="pl-4 text-sm text-gray-500">codeharem.com/profile/</span>
            <input
              id="username"
              type="text"
              value={username}
